		...
		if($this->isTextBoxEnabled()){
			$html = '
				<div class="text-box">
					...
					<input type="text" id="amount" readonly="readonly" style="background:none; border:none;" value="'.$this->getCurrencySymbol().$this->getCurrMinPrice().'" />
					<input type="text" id="amount-2" class="right" readonly="readonly" style="background:none; border:none;" value="'.$this->getCurrencySymbol().$this->getCurrMaxPrice().'" />
				</div>';
		}else{
			$html = '<p>
					<input type="text" id="amount" readonly="readonly" style="background:none; border:none;" value="'.$this->getCurrencySymbol().$this->getCurrMinPrice().'" />
				...
				jQuery(function($) {
					...
					$( "#slider-range" ).slider({
						...
						slide: function( event, ui ) {
							...
							$( "#amount" ).val( "'.$this->getCurrencySymbol().'" + newMinPrice );
							$( "#amount-2" ).val( "'.$this->getCurrencySymbol().'" + newMaxPrice );
