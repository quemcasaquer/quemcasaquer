...
class AW_Followupemail_Adminhtml_LinktrackingController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function viewOrderAction()
    {
        $id = Mage::getResourceModel('followupemail/linktracking_collection')
                ->getLinktrackingData(
                    ...
                    AW_Followupemail_Model_Source_Linktracking_Types::LINKTRACKING_TYPE_LINK_CART_ORDER);
