...
class AW_Followupemail_Block_Adminhtml_Queue_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('sent_at',
            array(
                ...
                'renderer' => 'AW_Followupemail_Block_Adminhtml_Queue_Grid_Column_Emptydate',
            )
        );
