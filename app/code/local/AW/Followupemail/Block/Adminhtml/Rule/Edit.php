...
class AW_Followupemail_Block_Adminhtml_Rule_Edit extends Mage_Adminhtml_Block_Widget_Form_Container 
{
...
function doBirthdayChanges(){
    if( $('event_type').getValue() == '".AW_Followupemail_Model_Source_Rule_Types::RULE_TYPE_CUSTOMER_BIRTHDAY."' )
    {
...
function checkEventType(){
    doBirthdayChanges();
    if(
        $('event_type').getValue() == '".AW_Followupemail_Model_Source_Rule_Types::RULE_TYPE_CUSTOMER_NEW."' ||
        $('event_type').getValue() == '".AW_Followupemail_Model_Source_Rule_Types::RULE_TYPE_CUSTOMER_BIRTHDAY."' ||
        $('event_type').getValue() == '".AW_Followupemail_Model_Source_Rule_Types::RULE_TYPE_CUSTOMER_LOGGED_IN."' ||
        $('event_type').getValue() == '".AW_Followupemail_Model_Source_Rule_Types::RULE_TYPE_CUSTOMER_LAST_ACTIVITY."' ||
        $('event_type').getValue() == '".AW_Followupemail_Model_Source_Rule_Types::RULE_TYPE_CUSTOMER_CAME_BACK_BY_LINK."')
    {
        ...
        $('event_type').getValue() == '".AW_Followupemail_Model_Source_Rule_Types::RULE_TYPE_WISHLIST_SHARED."' ||
        $('event_type').getValue() == '".AW_Followupemail_Model_Source_Rule_Types::RULE_TYPE_WISHLIST_PRODUCT_ADD."')
    {
        $('sku').up(1).show();
        $('sale_amount_container').hide();
    }
