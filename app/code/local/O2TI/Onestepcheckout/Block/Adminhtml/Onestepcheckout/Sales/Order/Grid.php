<?php
class O2TI_Onestepcheckout_Block_Adminhtml_Onestepcheckout_Sales_Order_Grid extends Mage_Adminhtml_Block_Sales_Order_Grid
{
// protected function _prepareLayout()
	...
	if(version_compare(Mage::getVersion(),'1.4.1.0','>=')){
        ...
        $collection->getSelect()->joinleft(array('one_step'=>$collect->getTable('o2ti_onestepcheckout')),'one_step.sales_order_id=main_table.entity_id',array('o2ti_deliverydate_date','o2ti_customercomment_info','o2ti_deliverydate_time'));		
        $this->setCollection($collection);
			...
			$collection->getSelect()->joinleft(			//array(	'one_step'=>'o2ti_onestepcheckout'),
														array('one_step'=>$collect->getTable('o2ti_onestepcheckout')),
														'one_step.sales_order_id=e.entity_id',
														array('o2ti_deliverydate_date','o2ti_customercomment_info','o2ti_deliverydate_time')
												);			
	        $this->setCollection($collection);
			}
...
protected function _prepareColumns()
		...
		$this->addColumn('o2ti_customercomment_info', array(
			'header' => Mage::helper('sales')->__('Customer Comment'),
			'index' => 'o2ti_customercomment_info',
			'type'  => 'text',

		));
		if(Mage::getStoreConfig('onestepcheckout/deliverydate/allow_options')){
			$this->addColumn('o2ti_deliverydate_date', array(
				'header' => Mage::helper('sales')->__('Delivery Date'),
				'index' => 'o2ti_deliverydate_date',
				'type'  => 'text',

			));
			$this->addColumn('o2ti_deliverydate_time', array(
				'header' => Mage::helper('sales')->__('Delivery Time'),
				'index' => 'o2ti_deliverydate_time',
				'type'  => 'text',
            ...
            if ($column->getFilterConditionCallback()) {
                ...
                if ($field && isset($cond)) {
                   // $this->getCollection()->addFieldToFilter($field , $cond);
					if($field=='o2ti_customercomment_info' OR $field=='o2ti_deliverydate_date' OR $field=='o2ti_deliverydate_time'){
