<?php
class O2TI_Moip_Model_Orders extends Mage_Payment_Model_Method_Abstract {
	public function cancel(){
		$date = date("Y-m-d H:i:s", mktime(0, 0, 0, date("m"), date("d")-Mage::getStoreConfig('payment/o2ti_moip_standard/vcmentoboleto'), date("Y")));
