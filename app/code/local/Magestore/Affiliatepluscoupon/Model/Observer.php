...
class Magestore_Affiliatepluscoupon_Model_Observer {
    ...
    public function editProgramForm($observer) {
        ...
        $fieldset->addField('coupon_pattern', 'text', array(
            ...
            'name' => 'coupon_pattern',
            'note' => Mage::helper('affiliatepluscoupon')->__('Used to generate coupon codes for Affiliates. Pattern examples:<br/><strong>[A.8] : 8 alpha characters<br/>[N.4] : 4 numeric characters<br/>[AN.6] : 6 alphanumeric characters<br/>AFFILIATE-[A.4]-[AN.6] : AFFILIATE-ADFA-12NF0O</strong>'),
        ));
    }
