...
class Magestore_Affiliateplusstatistic_ReportController extends Mage_Adminhtml_Controller_Action {
    ...
    public function impressionsAction() {
        ...
        $this->_initAction()
                ->_title($this->__('Impression Report'))
                ->_setActiveMenu('affiliateplus/statistic/impressions')
                ->_addBreadcrumb($this->__('Impression Report'), $this->__('Impression Report'));
    ...
    public function bestsellersAction() {
        ...
        $this->_initAction()
                ->_title($this->__('Bestseller Report'))
                ->_setActiveMenu('affiliateplus/statistic/bestsellers')
                ->_addBreadcrumb($this->__('Bestseller Report'), $this->__('Bestseller Report'));
    ...
    public function affiliatesAction() {
        ...
        $this->_initAction()
                ...
                ->_addBreadcrumb($this->__('Affiliate Account Report'), $this->__('Affiliate Account Report'));
