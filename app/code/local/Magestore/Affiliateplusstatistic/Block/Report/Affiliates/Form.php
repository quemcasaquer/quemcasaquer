<?php
class Magestore_Affiliateplusstatistic_Block_Report_Affiliates_Form extends Mage_Adminhtml_Block_Report_Filter_Form
{
	protected function _prepareForm(){
		...
		if (is_object($fieldset) && $fieldset instanceof Varien_Data_Form_Element_Fieldset){
			$values = array(
				array('value' => 1, 'label' => $this->__('Complete')),
