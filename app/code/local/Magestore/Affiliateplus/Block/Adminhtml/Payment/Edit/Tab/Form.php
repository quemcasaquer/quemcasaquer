...
//		));
        ...
        $params = array(
            'label' => Mage::helper('affiliateplus')->__('Withdrawal Amount'),
            'name' => 'amount',
            'class' => 'required-entry',
            'required' => true,
...
//			$fieldset->addField('status', 'select', $params);
    ...
    protected function _isActivePaymentPlugin() {
        ...
        if (isset($modulesArray['Magestore_Affiliatepluspayment']) && is_object($modulesArray['Magestore_Affiliatepluspayment']))
