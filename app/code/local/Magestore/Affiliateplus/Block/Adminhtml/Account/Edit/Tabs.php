	...
	protected function _beforeToHtml()
	{
		...
		if($id){
			$this->addTab('transaction_section', array(
				'label'     => Mage::helper('affiliateplus')->__('Transaction History'),
				'title'     => Mage::helper('affiliateplus')->__('Transaction History'),
				'url'		=> $this->getUrl('*/*/transaction',array('_current'=>true)),
		  		'class'     => 'ajax',  
			));
			
			$this->addTab('payment_section', array(
				'label'     => Mage::helper('affiliateplus')->__('Withdrawal History'),
				'title'     => Mage::helper('affiliateplus')->__('Withdrawal History'),
