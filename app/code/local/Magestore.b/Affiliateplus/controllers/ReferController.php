<?php
class Magestore_Affiliateplus_ReferController extends Mage_Core_Controller_Front_Action
{
	/**
	 * get Account helper
	 *
    ...
    public function emailAction(){
    	...
    	if ($data = $this->getRequest()->getPost()){
    		$emails = $data['emails'];
    		$subject = $data['email_subject'] ? $data['email_subject'] : Mage::getBlockSingleton('affiliateplus/refer')->getDefaultEmailSubject();
    		$content = $data['email_content'] ? $data['email_content'] : Mage::getBlockSingleton('affiliateplus/refer')->getDefaultEmailContent();
    		$session = $this->_getCoreSession();
    ...
    public function yahooAction(){
    	...
    	$yahoo = Mage::getSingleton('affiliateplus/refer_yahoo');
    ...
    public function gmailAction(){
    	...
    	$gmail = Mage::getSingleton('affiliateplus/refer_gmail');
    	if (!$gmail->isAuth())
    ...
    public function facebookAction(){
    	...
    	try {
			...
			if (!$message) $message = Mage::getBlockSingleton('affiliateplus/refer')->getDefaultSharingContent();
