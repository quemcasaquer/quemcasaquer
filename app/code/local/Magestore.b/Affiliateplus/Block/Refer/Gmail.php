<?php
class Magestore_Affiliateplus_Block_Refer_Gmail extends Magestore_Affiliateplus_Block_Refer_Abstract
{
	/**
	...
	public function getContacts(){
		...
		$google = Mage::getSingleton('affiliateplus/refer_gmail');
		$oauthData = array(
