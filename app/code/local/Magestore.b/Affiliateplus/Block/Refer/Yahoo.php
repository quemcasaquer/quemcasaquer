<?php
class Magestore_Affiliateplus_Block_Refer_Yahoo extends Magestore_Affiliateplus_Block_Refer_Abstract
{
	/**
	...
	public function getContacts(){
		$list = array();
		$session = Mage::getSingleton('affiliateplus/refer_yahoo')->getSession();
