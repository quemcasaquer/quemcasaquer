 ...
 *
 */
class Meigee_ThemeOptionsBlacknwhite_Block_Adminhtml_System_Config_Form_Field_Font2 extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html .= '<br/><div id="themeoptionsblacknwhite_gfont_preview" style="font-size:20px; margin-top:5px;">The quick brown fox jumps over the lazy dog</div>
		<script>
        ...
        googleFontPreviewModel.prototype = {
            initialize : function()
            {
                this.fontElement = $("meigee_blacknwhite_design_appearance_gfont");
                this.previewElement = $("themeoptionsblacknwhite_gfont_preview");
                this.loadedFonts = "";
