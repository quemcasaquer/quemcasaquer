 ...
 *
 */
class Meigee_ThemeOptionsBlacknwhite_Helper_Menu extends Mage_Core_Helper_Abstract
{
 
	public function getMenuStaticBlocks () {

		$staticList = Mage::getStoreConfig('meigee_blacknwhite_general/menu/menu_static');
