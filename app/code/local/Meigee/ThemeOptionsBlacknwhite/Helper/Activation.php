 ...
 *
 */
class Meigee_ThemeOptionsBlacknwhite_Helper_Activation extends Mage_Core_Helper_Abstract
{
    protected $settings;
    private $_file = '/app/code/local/Meigee/ThemeOptionsBlacknwhite/etc/blocks.xml';
