 ...
 *
 */
class Meigee_ThemeOptionsBlacknwhite_Model_Activation extends Mage_Core_Model_Abstract
{
    protected $settings;
    private $_file = '/app/code/local/Meigee/ThemeOptionsBlacknwhite/etc/import/cms.xml';
