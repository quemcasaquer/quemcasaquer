 ...
 */
class OnlineBiz_Facebookstore_Block_Product_Search extends Mage_Catalog_Block_Product_Abstract
{
    /**
    ...
    protected function _getProductCollection()
    {
        if (is_null($this->_productCollection)) {
			...
			if(Mage::helper('facebookstore')->showSpecCatalog()){
				...
				$this->_productCollection->addAttributeToFilter('category_id', array('in' => array('finset'=>implode(',', $this->getOnFacebookCategories())))); 
			}
