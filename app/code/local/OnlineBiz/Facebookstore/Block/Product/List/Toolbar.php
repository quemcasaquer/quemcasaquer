 ...
 */
class OnlineBiz_Facebookstore_Block_Product_List_Toolbar extends Mage_Core_Block_Template
{
    /**
     * Products collection
     *
    ...
    protected function _construct()
    {
        ...
        $this->setTemplate('onlinebizsoft/facebookstore/product/list/toolbar.phtml');
    }
    ...
    protected function _getAvailableLimit($mode)
    {
        ...
        $perPageConfigKey = 'facebookstore/general/frontend_per_page_values';
    ...
    public function getPagerHtml()
    {
        ...
        if ($pagerBlock instanceof Varien_Object) {
			...
			$pagerBlock->setTemplate('onlinebizsoft/facebooktimeline/page/html/pager.phtml');
