 ...
 */
class OnlineBiz_Facebookstore_Model_Client
{
	...
	public function __construct()
	{
		...
		if(count($args)<2) {
			trigger_error('Missing arguments for OnlineBiz_Facebookstore_Model_Client::__construct()',E_USER_ERROR);
		}
	...
	public function postWall($path, $params=array())
	{
		if ($path[0] != '/') {
			$path = '/'.$path;
		}
